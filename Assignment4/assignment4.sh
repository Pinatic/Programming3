...
seq 20 2 30 | parallel -j16 "velveth $OUTPUT/{} {} -fastq -longPaired $FILE_R1 $FILE_R2 && velvetg $OUTPUT/{} && cat &OUTPUT/{}/contigs.fa | (python3 assignment4.py && echo -e {}; ) >> output/output.csv"
